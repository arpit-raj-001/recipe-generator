...
Do not include any extra text, only the JSON object."""
        ...
        return jsonify({'recipe': recipe_json, 'generation_time': generation_time, 'model_used': model_name}), 200
...
def health_check():
    return jsonify({
        ...
        'models_available': {'huggingface': bool(hf_token), 'groq': bool(groq_token)},
